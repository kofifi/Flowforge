...
public class WorkflowVariableRepositoryTests
{
    ...
    public async Task AddAsync_AddsVariable()
    {
        ...
        var variable = new WorkflowVariable { Name = "Var", Type = "string", WorkflowId = workflow.Id };
    ...
    public async Task GetAllAsync_ReturnsAllVariables()
    {
        ...
        _context.WorkflowVariables.Add(new WorkflowVariable { Name = "A", Type = "int", WorkflowId = workflow.Id });
        _context.WorkflowVariables.Add(new WorkflowVariable { Name = "B", Type = "string", WorkflowId = workflow.Id });
        await _context.SaveChangesAsync();
    ...
    public async Task GetByIdAsync_ReturnsVariable_WhenExists()
    {
        ...
        var variable = new WorkflowVariable { Name = "A", Type = "int", WorkflowId = workflow.Id };
    ...
    {
        var variable = new WorkflowVariable { Id = 123, Name = "X", Type = "int", WorkflowId = 1 };
        var updated = await _repository.UpdateAsync(variable);
